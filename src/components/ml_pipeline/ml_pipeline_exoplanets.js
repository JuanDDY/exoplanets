...
import "./MlPipelineComponent.css";

const MlPipelineExoplanets = () => {
  ...
  return (
    <div className="ml-pipeline-container">
      <Container className="py-5">
        <h1 className="text-center ml-pipeline-title fw-bold mb-4" style={{ fontSize: "2.5rem" }}>Descubre más allá del sistema solar</h1>
...
export default MlPipelineExoplanets;
