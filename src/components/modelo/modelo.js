...
const Modelo = () => {
  ...
  // Datos embebidos como fallback para variables
  const fallbackVariableData = {
    "period_days": {
      "personaje": "Amanda",
      "explicacion": [
  ...
  // Cargar explicaciones al montar el componente
  useEffect(() => {
    setVariableExplanations(fallbackVariableData);
    setEducationExplanations(fallbackEducationData);
    setMlPipelineExplanations(fallbackMlPipelineData);
